...
urlpatterns = [
    ...
    path('<int:pk>', DetailBureauView.as_view(), name='detail_bureau'),
    path('<int:pk>/fermer', CloseBureauView.as_view(), name='close_bureau'),
    path('<int:pk>/results', BureauResultsView.as_view(), name='results_bureau'),
    path('<int:pk>/vote', FindVoterInListView.as_view(), name='vote_bureau'),
    path('<int:pk>/vote/homonymes', SelectHomonymView.as_view(), name='select_homonym'),
]
